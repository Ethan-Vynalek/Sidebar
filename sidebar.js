$(document).ready(function(){
   ...
   // Compile schedule data into an ObjectURL, return the URL used to download it
    ...
    /*
    var ApiKey = 'AIzaSyBj8beZN35sBkhc6_Dn5_Gymgq8_AJ0liM';
    var scopes = 'https://www.googleapis.com/auth/calendar';
    var clientId = '637150883276-n09l4a128cufftk53o4otsgc4n1vopnt.apps.googleusercontent.com';
    ...
    function handleAuthResult(authResult) {
        ...
        if (authResult && !authResult.error) {
            auth_button.style.visibility = 'hidden';
            makeApiCall();
        } else {
            auth_button.style.visibility = '';
            auth_button.onclick = handleAuthClick;
        }
    }
