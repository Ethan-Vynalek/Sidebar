$(document).ready(function(){
    ...
    // Javascript Client Library - Google Calendar API request
    // Code adapted from examples given by Google's dev resources API Client Library for Javascript
    ...
    function handleAuthResult( authResult ) {
        ...
        if ( authResult && !authResult.error ) {
            ...
            makeApiCall(); // IS THIS A FILLER LINE? DO WE HAVE TO INPUT AN ACTUAL FUNCTION HERE OR IS THIS AUTOMATIC?
        } else {
